...
const articles = [
  ...
  {
    to: "/resources/country-indonesia",
    title: "resources.articles.countryIndonesia.title",
    titleEn: "EUDR Indonesia: Palm Oil & Rubber Compliance Guide",
    description: "resources.articles.countryIndonesia.description",
    descriptionEn: "Country-specific EUDR requirements for Indonesian palm oil and rubber imports.",
    category: "resources.categories.country",
    categoryEn: "Country Guide",
    readTime: "resources.articles.countryIndonesia.readTime",
    readTimeEn: "5 min read",
  },
  {
    to: "/resources/country-brazil",
    title: "resources.articles.countryBrazil.title",
    titleEn: "EUDR Brazil: Soy, Cattle & Wood Compliance Guide",
    description: "resources.articles.countryBrazil.description",
    descriptionEn: "Country-specific EUDR requirements for Brazilian soy, cattle, and wood imports.",
    category: "resources.categories.country",
    categoryEn: "Country Guide",
    readTime: "resources.articles.countryBrazil.readTime",
    readTimeEn: "5 min read",
  },
  {
    to: "/resources/country-vietnam",
    title: "resources.articles.countryVietnam.title",
    titleEn: "EUDR Vietnam: Rubber & Coffee Compliance Guide",
    description: "resources.articles.countryVietnam.description",
    descriptionEn: "Country-specific EUDR requirements for Vietnamese rubber and coffee imports.",
    category: "resources.categories.country",
    categoryEn: "Country Guide",
    readTime: "resources.articles.countryVietnam.readTime",
    readTimeEn: "5 min read",
  },
  {
    to: "/resources/country-west-africa",
    title: "resources.articles.countryWestAfrica.title",
    titleEn: "EUDR Ghana & Côte d'Ivoire: Cocoa Compliance Guide",
    description: "resources.articles.countryWestAfrica.description",
    descriptionEn: "Country-specific EUDR requirements for West African cocoa imports.",
    category: "resources.categories.country",
    categoryEn: "Country Guide",
    readTime: "resources.articles.countryWestAfrica.readTime",
    readTimeEn: "5 min read",
  },
];

  ...
  return (
    <motion.div
      ...
      className={`flex justify-start md:gap-10 ${
        index === 0 ? "pt-8 md:pt-16" : "pt-10 md:pt-40"
      }`}
    >
      <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
        <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
          <div className="h-4 w-4 rounded-full bg-primary/30 border border-primary/40 p-2" />
        </div>
...
export const Timeline = ({
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pt-8 pb-0 px-4 md:px-8 lg:px-10">
        {title && (
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-blue-800 via-blue-600 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
